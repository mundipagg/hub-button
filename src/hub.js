function Hub(config) {
	...
	this.urlToIntegratePtBr = "https://hub.mundipagg.com/apps/{publicAppKey}/authorize?redirect={redirectUrl}";
	this.urlToViewPtBr = "https://hub.mundipagg.com/apps/{publicAppKey}/edit/{installId}";
	...
	this.setup = function(config) {
		...
		createButton(text, function() { window.location.href = url; });
	}; 	
